...
def main():
    ...
    print()
    print("  Fixed-orientation constructions tested here:")
    print("  (same Kraus output target states for all a; only the scalar")
    print("  sqrt(1-lambda_Q(a)^2) varies with a).")
    print("  These tested constructions do not select a=0:")
    print("    Q->Q is exactly a-independent;")
    print("    Q->v0 selects a=1/3 on the grid;")
    print("    mixed selects a=1/3 on the grid;")
    print("    128 random fixed orthonormal output pairs peaked at a≈0.35 on the grid.")
    print("  This is sampled evidence, not a theorem over the full fixed-orientation class.")
    print()
    ...
    print("  The open question is which completion class (if any) is physically")
    print("  justified by the PF framework, not whether some CPTP completion can")
    print("  select a=0 (it can).")
    print()
    ...
    print("  remain underdetermined until a physically-justified completion class")
    print("  is derived from PF premises.")
