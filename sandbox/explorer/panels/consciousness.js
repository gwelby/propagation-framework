    ...
    renderInfo: function (ctx) {
      ...
      state.info.innerHTML =
        '<div class="panel-header">' +
          ...
          '</div>' +
          '<span class="status-pill status-intuition">INTUITION</span>' +
        '</div>' +
        ...
        '</div>' +
        '<div class="note-box audit-only"><strong>Audit</strong><p>The consciousness claim remains INTUITION — the operational PF-specific metric is the key missing piece. The Aria self-reference loop is ARGUED as an architecture milestone, not as consciousness evidence.</p></div>' +
        '<div class="stat-grid">' +
