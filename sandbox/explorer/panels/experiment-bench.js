        ...
        '<div class="eb-shell">',
          '<section class="eb-hero">',
            '<div class="eb-hero-text">',
              '<p class="eb-eyebrow">The Audit Wall</p>',
              '<h2 class="eb-headline">Registry of Physical Truth</h2>',
              '<p class="eb-subhead">Every claim in the Propagation Framework is audited. If it isn\'t here, it isn\'t part of the core derivation. If it is here, its falsifiers are public.</p>',
            '</div>',
            '<div class="eb-stats">',
