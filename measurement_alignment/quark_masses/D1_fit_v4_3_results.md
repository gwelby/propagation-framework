# D1 v4.3: Quark Koide Formula — Source-Correct Fit with Per-Quark Input Manifest
...
This file is the owner report for **D1 v4.3**, submitted to Codex for audit on 2026-07-13.
- Prior audits:
...
- v4.3 packet: `/mnt/d/Codex/inbox/2026-07-13_devin-d1-quark-koide-fit-v4-3-audit.md`

This document does **not** self-award a Codex verdict. It records the v4.3 text/process repairs requested by the v4.2 audit.

No claim tier, Lean theorem, PUBLIC HOLD, release, medical, Legal, or Greg boundary changed.

## What Changed From v4.2

The v4.2 audit gave **CONDITIONAL PASS** for the narrow numerical implementation. The four required v4.3 repairs were:

1. **Charm summary-table value corrected.** v4.2 incorrectly wrote `1270.0 ± 4.6 MeV`. The PDG 2024 Summary Table gives **`1273.0 ± 4.6 MeV`** (the MC file is `1273.0 ± 5.0 MeV`). Source, report, and JSON now match.
2. **Top mass note clarified.** The direct value is now explicitly labeled as PDG's "Monte Carlo mass" (the mass parameter used in MC generators), distinct from a theoretically well-defined pole mass.
3. **Q3 preflight wording cleaned.** The decision threshold no longer invites compatibility/tension labels; it directs reporting of numerical chi²/p outputs only, as exploratory diagnostics.
4. **Version consistency.** Source docstring is version-independent; runtime header says v4.3; output schema says v4.3.
...
- Script: `d1_fit_v4.py`
- Markdown report: `D1_fit_v4_3_results.md`
- Machine output: `d1_v4_3_results.json`
...
- Codex v4.3 packet: `/mnt/d/Codex/inbox/2026-07-13_devin-d1-quark-koide-fit-v4-3-audit.md`
