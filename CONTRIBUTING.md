...
**Files**: `derivations/g3_coupling_bridge.md`, `derivations/g3_product_walk_no_go.md`, `derivations/g3_triangular_gaussian_family.md`, `derivations/g3_wilson_loop_toy_model.md`
...
**What would close it**: A proof that a genuinely non-commuting transport family with framework-fixed connection geometry, or a holonomy-style observable that eliminates the free geometric parameter, produces exactly N^{D/2} coherence volume with no free prefactor, together with the exact map to α(l_P).
