...
**Files**: `derivations/g3_coupling_bridge.md`, `derivations/g3_product_walk_no_go.md`, `derivations/g3_triangular_gaussian_family.md`
...
**What would close it**: A proof that a genuinely non-commuting phase-dependent kernel family and physically correct closure observable produce exactly N^{D/2} coherence volume with no free prefactor, together with the exact map to α(l_P).
